...
//public class LearningRecordDelayTaskHandler1 {
//
...
//    private static volatile boolean begin = true; // volatile关键字防止出现修改了这个变量但对其他线程不可见的情况
//    private final static Executor es = Executors.newFixedThreadPool(4);
//
//    // 定义两个生命周期函数
//    @PostConstruct // 在当前类被初始化，上面的Bean都完成注入之后，来调用init()
//    public void init(){
//        CompletableFuture.runAsync(this::handleDelayTask, es); // 线程的异步执行
//    }
//
